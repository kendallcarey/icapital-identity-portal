...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference("Investor.count") do
      post investors_url, params: { investor: { dob: @investor.dob, first_name: @investor.first_name, last_name: @investor.last_name, phone: @investor.phone, state: @investor.state, street_address: @investor.street_address, zip: @investor.zip } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { dob: @investor.dob, first_name: @investor.first_name, last_name: @investor.last_name, phone: @investor.phone, state: @investor.state, street_address: @investor.street_address, zip: @investor.zip } }
